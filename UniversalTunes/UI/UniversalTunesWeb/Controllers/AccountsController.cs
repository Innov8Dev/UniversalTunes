...
namespace UniversalTunesWeb.Controllers
{
    ...
    public class AccountsController : ApiController
    {
        ...
        public async Task<IHttpActionResult> Login(LoginViewModel model)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    var currentUser = db.AspNetUsers.Where(x => x.UserName == model.Email).SingleOrDefault();
        ...
        [AllowAnonymous]
        public async Task<IHttpActionResult> ForgotPasswordConfirmation()
        {
            return Ok();
        }
        ...
        [AllowAnonymous]
        public async Task<IHttpActionResult> ExternalLoginFailure()
        {
            return Ok();
        }
        ...
        private static void RedirectToLocal(string returnUrl, HttpResponse response)
        {
