...
<head runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        var base = "/siteitems"; /*Relative to Root*/
        ...
        function renderTree(bPreview) {
            ...
            $('#container_id').fileTree({
                root: base + '/',
                script: 'jqueryFileTree/jqueryFileTree.aspx' + qs,
                expandSpeed: 750,
                collapseSpeed: 750,
        ...
        function deleteFile() {
            if (confirm("Are you sure you want to delete this file?")) {
                $.post('server/delfile.ashx', { file: $("#idFile").attr("href") },
                function (data) {
                    refresh();
        ...
        function deleteFolder() {
            if (confirm("Are you sure you want to delete this folder?")) {
                $.post('server/delfolder.ashx', { folder: $("#active_folder").val() },
                function (data) {
        ...
        function createFolder() {
            $.post('server/newfolder.ashx', { folder: $("#active_folder").val() + "/" + $("#inpFolder").val() },
                function (data) {
                    refresh();
                    $("#inpFolder").val("");
                });
        ...
        function panelUpload() {            
            ...
            if(flashUpload) {
                ...
                $("body", d).append([
                    "<form method='post' action='server/upload.ashx' enctype='multipart/form-data' onsubmit='return (document.getElementById(\"File1\").value!=\"\") '> ",
